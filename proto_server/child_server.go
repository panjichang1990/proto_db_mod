...
type ChildServer interface {
	...
	NoRealReg(ctx context.Context, in *NoRealRegReq, opts ...client.CallOption) (*NoRealRegRep, error)
}
...
type ChildServerHandler interface {
	...
	NoRealReg(context.Context, *NoRealRegReq, *NoRealRegRep) error
}
...
func (h *childHandler) NoRealReg(ctx context.Context, in *NoRealRegReq, out *NoRealRegRep) error {
	return h.ChildServerHandler.NoRealReg(ctx, in, out)
}
...
func (c *childService) NoRealReg(ctx context.Context, in *NoRealRegReq, opts ...client.CallOption) (*NoRealRegRep, error) {
	req := c.c.NewRequest(c.serviceName, "ChildServer.NoRealReg", in)
	out := new(NoRealRegRep)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
	}
